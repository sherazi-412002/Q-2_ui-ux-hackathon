...
//           <ul key={item._id} className="space-y-3 sm:space-y-4 lg:space-y-5">
...
//               <p>
//                 <span className="text-text1">{item.title}</span> x 1
//               </p>
//               <p>{item.price}</p>
//             </li>
//             <li className="flex justify-between">
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap md:flex-nowrap justify-center px-5 xl:px-0 gap-6 sm:gap-8 lg:gap-[26px]">
        ...
        {/* Billing Section */}
        <div className="w-full md:w-[608px] mt-[40px] px-4 md:px-0">
          <h2 className="text-[36px] font-semibold ml-0 md:ml-[74px]">Billing Details</h2>
          <ul className="ml-0 md:ml-[76px] mt-4 space-y-6">
            <li className="flex flex-wrap gap-4">
              <div className="flex flex-col gap-[12px]">
                <legend>First Name</legend>
                <input type="text" name='firstName' onChange={handleInputChange} value={customerInfo.firstName} className=""/>
              </div>
              <div className="flex flex-col gap-[12px]">
                <legend>Last Name</legend>
                <input type="text" name='lastName' onChange={handleInputChange} value={customerInfo.lastName} className="input-field"/>
              </div>
            </li>
            <li className="flex flex-col gap-[12px]">
              <legend>Email Address</legend>
              <input type="email" name='email' onChange={handleInputChange} value={customerInfo.email} className="input-field"/>
            </li>
            <li className="flex flex-col gap-[12px]">
              <legend>Phone</legend>
              <input type="tel" name='phone' onChange={handleInputChange} value={customerInfo.phone} className="input-field"/>
            </li>
          </ul>
        </div>
        ...
        <div className="w-full md:w-[608px] mt-[40px] px-4 md:px-0">
          ...
          <div className="flex justify-between">
            <p>Total</p>
            <p className="text-[24px] font-bold text-primary1">${totalAmount}</p>
          </div>

          <button onClick={handleCheckout} className="btn-primary mt-[20px]">Place Order</button>
        </div>
      </div>
    </div>
  );
